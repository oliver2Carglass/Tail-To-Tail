class Player:
    def __init__(self, player_id):
        ...
        self.grid[self.position[0]][self.position[1]] = self.player_id
    ...
    def canMove(self, direction):
        ...
        # Vérifier si la nouvelle position est déjà occupée par ce joueur (pas sur son propre chemin)
        if self.grid[next_position[0]][next_position[1]] == self.player_id:
            return False
    ...
    def move(self, direction):
        ...
        self.grid[self.position[0]][self.position[1]] = self.player_id  # Mettre à jour la grille
    ...
    def reset_player(self):
        ...
        self.grid[self.position[0]][self.position[1]] = self.player_id  # Marquer la nouvelle position
...
# p1= Player(1)
# p1.move("up")
# display_grid(p1.get_grid_state())
